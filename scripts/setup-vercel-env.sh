...
add AGENT_WEBHOOK_BASE_URL "https://dokind.ai"
add NEXT_PUBLIC_APP_URL "https://dokind.ai"
add ALERT_EMAIL "carly@dokindtx.com"
add EMAIL_FROM "Carly Bryant <carly@dokindtx.com>"
